...
import translator from "../../resource/Translator.png"
        ...
        <div className="projects_container">
          <div className="project">
            ...
            <div className="project_information" data-aos="fade-right">
              ...
              <div>
                <a
                  href="https://imaginative-baklava-6cdda4.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
        ...
        <div className="projects_container">
          <div className="project">
            ...
            <div className="project_information" data-aos="fade-right">
              <h2>Translator</h2>
              <p>
                This project is about building a web application to translate
                languages using language translator API from external services.
                Here you will be able to translate between multiple languages
                and whenever you type something it will be automatically
                translated in the side panel.
              </p>
              <div>
                <FaReact />
                <IoLogoJavascript />
              ...
              <div>
                <a
                  href="https://eloquent-daifuku-05b55c.netlify.app/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <span type="button" className="btn btn--outline onbt">
                ...
                <a
                  href="https://github.com/imran120198/Translation-App"
                  target="_blank"
                  rel="noreferrer"
                >
                  <span type="button" className="btn btn--outline">
